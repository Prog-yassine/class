...
ITEM_INFO = {
    "apple": {
        ...
        "calories": 52,
        "origin": "France",
        "description": "La pomme est un fruit croquant et juteux, riche en fibres alimentaires qui aident à la digestion. Elle est également une excellente source de vitamine C, essentielle pour renforcer le système immunitaire. Originaire de France, elle est cultivée dans des vergers respectueux de l'environnement pour offrir une qualité supérieure.",
        "color": "#d32f2f"
    },
    "banana": {
        "label": "Banana",
        ...
        "calories": 89,
        "origin": "Équateur",
        "description": "La banane est un fruit tropical doux et énergétique, parfaite pour un en-cas rapide. Elle fournit une bonne quantité de potassium, important pour la santé cardiovasculaire, et contient des glucides naturels pour une énergie durable. Provenant d'Équateur, elle est récoltée à maturité pour garantir sa saveur optimale et ses bienfaits nutritionnels.",
        "color": "#fbc02d"
    },
}
...
class FruitKioskApp:
    def __init__(self, root):
        ...
        # Camera (used only for detection)
    ...
    def update_center_panel(self):
        ...
        if self.detail_view and self.selected_item in self.detected_items:
            ...
            self.center_subtitle.config(
                text=f"Prix: ${item['price']:.2f}  |  Calories: {item['calories']} kcal"
            )
    ...
    def detect_fruits(self, frame):
        ...
        results = self.model(small, conf=0.4)
